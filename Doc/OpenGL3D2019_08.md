...
glTFは以下の要素で構成されます。いくつかの要素は前掲したgltfファイルにも含まれているのが分かりますね。
...
+  void SetAttribute(Primitive*, int, const json11::Json&, const json11::Json&,
...
<img src="images/08_gltf_buffers_bufferviews_accessors.png" style="width:50%; margin-left:auto; margin-right:auto"/>
</div>
